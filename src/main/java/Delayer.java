...
/**
 * Delays forwarding of ClickRecords based on their timestamp.
 ...
 */
public class Delayer implements UnaryOperator<ClickRecord> {
    ...
    @Override
    public ClickRecord apply(ClickRecord record) {
